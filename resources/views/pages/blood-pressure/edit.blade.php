<x-app-layout>
    ...
    <div class=" p-2 md:p-4">
        <form action="{{ route('blood-pressure.update',$presion['id']) }}" method="POST" class="mt-3">
            @csrf
            @method('PUT')
            <div class="bg-blue-100 rounded p-2 mb-3">
                ...
                <div class="mb-4">
                    ...
                    <input type="datetime-local" name="measured_at" required id="measured_at"
                        class="w-full border bg-white border-gray-400 outline-none focus:border-blue-500  rounded p-2" value="{{$presion->measured_at}}">
                    @error('measured_at')
                ...
                <div class="grid grid-cols-1 md:gap-3 md:grid-cols-2">
                    <div>
                        ...
                        <input type="number" name="systolic" min="50" max="250" id="systolic" required value="{{$presion->systolic}}"
                    ...
                    <div>
                        ...
                        <input type="number" name="diastolic" min="30" max="150" id="diastolic" required value="{{$presion->diastolic}}"
            ...
            <div class="grid grid-cols-1 md:gap-3 md:grid-cols-2">
                <div class="mb-4">
                    ...
                    <input type="number" name="pulse" min="30" max="200" id="pulse" value="{{$presion->pulse}}"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="temperature" min="35" max="42" step="0.1" id="temperature" value="{{$presion->temperature}}"
            ...
            <div class="mb-4">
                ...
                <textarea name="notes" id="notes" class="w-full border border-gray-400 outline-none focus:border-blue-500  rounded p-2" rows="3"
                    placeholder="Ej: Me sentí mareado antes de la medición..."> {{$presion->notes }} </textarea>
                @error('notes')
                <p class="bg-red-400 text-white font-medium p-2 rounded mt-1"> {{$message}} </p>
                @enderror
            </div>
